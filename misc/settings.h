...
enum { SCAN_RESUME_TO = 0, SCAN_RESUME_CO, SCAN_RESUME_SE };
...
enum { OUTPUT_POWER_LOW = 0, OUTPUT_POWER_MID, OUTPUT_POWER_HIGH };
...
typedef struct {
  uint8_t ScreenChannel[2];  // current channels set in the radio (memory or
                             // frequency channels)
