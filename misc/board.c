...
void BOARD_PORTCON_Init(void) {
  ...
  PORTCON_PORTA_SEL1 |=
      ...
      // Battery voltage, wasn't cleared in previous step / relying on default
      // value!
      ...
      // Battery Current, wasn't cleared in previous step / relying on default
      // value!
  ...
  PORTCON_PORTB_IE |= 0 | PORTCON_PORTB_IE_B14_BITS_ENABLE;
  PORTCON_PORTB_IE &= ~(0
                        // Back light
